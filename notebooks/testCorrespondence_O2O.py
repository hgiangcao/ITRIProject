...
setting = "RGBD"
config["model"] = "Resnet"
model_path = "DON_GraspNet_RGBD_Resnet8/DON_5001"
#"DON_Res348_cross_RGBD_Resnet_orig"
DON = DensObjectNet(setting=setting, pretrained=model_path)


FOLDER_NAME1=  "../DON_data/" + "GraspNet_train_O2O_real/Object99/001"
FOLDER_NAME2= "../DON_data/" + "GraspNet_train_O2O_sm_lg_rd/Object99/001"
...
##if 1 is REAL
poseCamera1, imageColor1, depth1, mask1, indexMap1, segmentMap1,uvSeg_1, arrObjectPose1 = dataGenerator.getImageData_Real(FOLDER_NAME1, idx1)
#if 2 is SIM
...
#if 2 is REAL
poseCamera2, imageColor2, depth2, mask2, indexMap2, segmentMap2,uvSeg_2, arrObjectPose2 = dataGenerator.getImageData_Real(FOLDER_NAME2, idx2)



#rotataion if needed
# depth2 = cv2.rotate(depth2, cv2.ROTATE_90_CLOCKWISE)
# mask2 = cv2.rotate(mask2, cv2.ROTATE_90_CLOCKWISE)
# imageColor2 = cv2.rotate(imageColor2, cv2.ROTATE_90_CLOCKWISE)
