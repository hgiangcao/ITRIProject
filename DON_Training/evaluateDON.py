...
from DON_Training.DataGenerator_O2O import DataGenerator,loadAllModels,convertToHeatmap,project_real,render,remove_values_from_list,processImage
...
def evaluateSinglePair(savedModel, inputMode,sceneType = None,unseen = 0):
    ...
    if(sceneType is None):
        sceneType =  np.random.choice([3,4,5,6,7])
    result = np.zeros(2)
